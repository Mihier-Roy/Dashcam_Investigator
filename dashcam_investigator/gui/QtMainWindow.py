...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.navigation_tab.setGeometry(QRect(0, 0, 131, 975))
        self.stack_widget = QStackedWidget(self.centralwidget)
        self.stack_widget.setObjectName(u"stack_widget")
        self.stack_widget.setGeometry(QRect(140, 0, 1461, 975))
        ...
        self.new_project_button.setFont(font1)
        ...
        self.existing_project_button.setFont(font1)

        self.landing_options_layout.addWidget(self.existing_project_button)

        self.layoutWidget_2 = QWidget(self.welcome_page)
        self.layoutWidget_2.setObjectName(u"layoutWidget_2")
        self.layoutWidget_2.setGeometry(QRect(0, 20, 1451, 66))
        self.tool_header = QVBoxLayout(self.layoutWidget_2)
        self.tool_header.setObjectName(u"tool_header")
        self.tool_header.setContentsMargins(0, 0, 0, 0)
        self.tool_label = QLabel(self.layoutWidget_2)
        self.tool_label.setObjectName(u"tool_label")
        font2 = QFont()
        font2.setPointSize(24)
        self.tool_label.setFont(font2)
        ...
        self.layoutWidget_3.setGeometry(QRect(310, 0, 1221, 971))
        ...
        self.player_controls.setMinimumSize(QSize(1150, 50))
        self.player_controls.setMaximumSize(QSize(1220, 50))
        ...
        self.horizontal_slider.setGeometry(QRect(90, 0, 1025, 22))
        self.horizontal_slider.setMinimumSize(QSize(1025, 0))
        self.horizontal_slider.setMaximumSize(QSize(1025, 16777215))
        ...
        self.total_duration.setGeometry(QRect(1140, 0, 61, 21))
