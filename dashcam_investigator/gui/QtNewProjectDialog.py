...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.input_dir_label.setText(
            QCoreApplication.translate("Dialog", "Dashcam Directory", None)
        )
        self.input_dir_button.setText(QCoreApplication.translate("Dialog", "...", None))
        self.output_dir_button.setText(
            QCoreApplication.translate("Dialog", "...", None)
        )
        self.output_dir_label.setText(
            QCoreApplication.translate("Dialog", "Ouput Directory", None)
        )
        self.case_label.setText(QCoreApplication.translate("Dialog", "Case Name", None))
        self.investigator_label.setText(
            QCoreApplication.translate("Dialog", "Investigator Name", None)
        )
        self.input_dir_help.setText(
            QCoreApplication.translate(
                "Dialog", "Select the directory where dashcam evidence is stored", None
            )
        )
        self.output_dir_help.setText(
            QCoreApplication.translate(
                "Dialog",
                "Select the directory where output from the tool will be stored",
                None,
            )
        )
        self.case_help.setText(
            QCoreApplication.translate("Dialog", "Enter the name of the case", None)
        )
        self.investigator_help.setText(
            QCoreApplication.translate("Dialog", "Enter your name", None)
        )
        self.new_project_label.setText(
            QCoreApplication.translate("Dialog", "New Project", None)
        )
