...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.landing_options_layout.setObjectName("landing_options_layout")
        ...
        self.existing_project_button.setObjectName("existing_project_button")
        ...
        self.directory_tab.setObjectName("directory_tab")
        ...
        sizePolicy.setHeightForWidth(
            self.dir_tree_view.sizePolicy().hasHeightForWidth()
        )
        ...
        self.videos_tab.setObjectName("videos_tab")
        ...
        self.video_workarea.setObjectName("video_workarea")
        ...
        self.horizontal_slider.setGeometry(QRect(90, 0, 900, 22))
        ...
        self.maps_web_view.setObjectName("maps_web_view")
        ...
        self.graph_web_view.setObjectName("graph_web_view")
        ...
        self.flag_description_label.setObjectName("flag_description_label")
        ...
        sizePolicy2.setHeightForWidth(
            self.save_note_button.sizePolicy().hasHeightForWidth()
        )
        ...
        self.save_note_label.setObjectName("save_note_label")
        ...
        self.note_status.setObjectName("note_status")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.welcome_label.setText(
            QCoreApplication.translate(
                "MainWindow",
                "Welcome to the tool! Please select an action to perform",
                None,
            )
        )
        self.new_project_button.setText(
            QCoreApplication.translate("MainWindow", "Create a new project", None)
        )
        self.or_label.setText(QCoreApplication.translate("MainWindow", "OR", None))
        self.existing_project_button.setText(
            QCoreApplication.translate("MainWindow", "Open an existing project", None)
        )
        self.file_tab.setTabText(
            self.file_tab.indexOf(self.directory_tab),
            QCoreApplication.translate("MainWindow", "Directory", None),
        )
        self.file_tab.setTabText(
            self.file_tab.indexOf(self.videos_tab),
            QCoreApplication.translate("MainWindow", "Videos", None),
        )
        self.video_title.setText(
            QCoreApplication.translate("MainWindow", "Currently playing : ", None)
        )
        ...
        self.data_tabs.setTabText(
            self.data_tabs.indexOf(self.graph_tab),
            QCoreApplication.translate("MainWindow", "Speed Graph", None),
        )
        self.flag_video_button.setText(
            QCoreApplication.translate("MainWindow", "Flag Video", None)
        )
        self.flag_description_label.setText(
            QCoreApplication.translate(
                "MainWindow", "Flag a video for future review", None
            )
        )
        self.save_note_button.setText(
            QCoreApplication.translate("MainWindow", "Save Note", None)
        )
        self.save_note_label.setText(
            QCoreApplication.translate(
                "MainWindow", "Save notes for the given video", None
            )
        )
        self.note_status.setText("")
        self.notes_label.setText(
            QCoreApplication.translate("MainWindow", "Enter notes for this video", None)
        )
        self.notes_textbox.setPlaceholderText(
            QCoreApplication.translate("MainWindow", "Start typing here...", None)
        )
        self.data_tabs.setTabText(
            self.data_tabs.indexOf(self.notes_tab),
